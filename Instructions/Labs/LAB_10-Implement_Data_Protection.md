...
1. From the Cloud Shell pane, run the following to specify the resource group that will be hosting the virtual machines. Type each command line separately and execute them separately:
   ...
   $rgName =  <Your Resource Group Name> ex. 'az104student10RG1'
    ```
...
1. On the **Create Recovery Services vault** blade, specify the following settings:
    ...
    | Resource group | the name of your existing resource group **az104student10RG1** |
...
2. Select your first resource group _ex. az104student10RG1'_
